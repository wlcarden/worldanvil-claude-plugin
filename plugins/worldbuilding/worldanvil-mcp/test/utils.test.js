...
describe('markdownToBBCode', () => {
  ...
  describe('text formatting', () => {
    ...
    it('should convert strikethrough', () => {
      expect(markdownToBBCode('~~strikethrough~~')).toBe('[s]strikethrough[/s]');
    });
  ...
  describe('code', () => {
    it('should convert inline code', () => {
      expect(markdownToBBCode('Use `code` here')).toBe('Use [code]code[/code] here');
    });
  ...
  describe('links', () => {
    it('should convert links', () => {
      expect(markdownToBBCode('[text](https://example.com)'))
        .toBe('[url=https://example.com]text[/url]');
    });

    it('should convert multiple links', () => {
      const input = '[link1](http://a.com) and [link2](http://b.com)';
      const expected = '[url=http://a.com]link1[/url] and [url=http://b.com]link2[/url]';
      expect(markdownToBBCode(input)).toBe(expected);
    });
  });
  ...
  describe('blockquotes', () => {
    it('should convert blockquotes', () => {
      expect(markdownToBBCode('> This is a quote')).toBe('[quote]This is a quote[/quote]');
    });
